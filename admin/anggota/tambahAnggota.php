...
if (isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO anggota (id_anggota, nama, tempat_lahir, tgl_lahir, alamat, jenis_kelamin, nmr_telp, foto)
            VALUES ('$id_anggota','$nama_anggota','$tempat_lahir', '$tanggal_lahir', '$alamat_anggota', '$jenis_kelamin', '$nomor_telepon', '$foto_anggota')";
    ...
    <hr class="line-page">
      ...
      <div class="tambah-anggota-container">
          <form action="" method="post">
              ...
              <div class="col-sm-10">
                  <input type="text" class="form-control" name="foto_anggota" id="foto_anggota">
              </div>
              </div>
