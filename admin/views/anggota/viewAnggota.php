...
<div class="right-container">
  ...
  <div class="container-fluid">
    ...
    <div class="tambah-anggota-btn">
      <a href="viewTambahAnggota.php" class="btn">
          Tambah Anggota
      </a>
    </div>
    ...
    <div class="table">
      ...
      <tbody>
          ...
          while($anggota = mysqli_fetch_array($query)){
              ...
              echo "<td>";
              echo "<a class='btn btn-table edit' href='viewEditAnggota.php?id_anggota=".$anggota['id_anggota']."'>Edit</a>";
              echo "<a class='btn btn-table view' href='viewProfileAnggota.php?id_anggota=".$anggota['id_anggota']."'>View</a>";
              echo "<a class='btn btn-table' href='../../models/anggota/deleteAnggota.php?id_anggota=".$anggota['id_anggota']."'>Hapus</a>";
              echo "</td>";
