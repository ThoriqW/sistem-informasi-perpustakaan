  ...
  <div class="container-fluid">
    ...
    <hr class="line-page">
      ...
      <div class="tambah-anggota-container">
          <form action="../../models/anggota/editAnggota.php" method="post" enctype="multipart/form-data">
              <div class="row mb-3">
              <label for="inputEmail3" class="col-sm-2 col-form-label">ID Anggota</label>
                  <div class="col-sm-10">
                  <input type="text" class="form-control" name="id_anggota" id="id_anggota" value="<?php echo $row['id_anggota'] ?>" readonly>
              </div>
              </div>
              <div class="row mb-3">
